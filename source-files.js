...
sourcesIndex["sampitor"] = {"name":"","dirs":[{"name":"dsp","files":["buffer.rs","mod.rs"]},{"name":"io","files":["event.rs","mod.rs","path.rs","terminal.rs"]},{"name":"ui","files":["axes.rs","mod.rs","util.rs"]},{"name":"view","files":["base.rs","chart.rs","file.rs","filters.rs","menu.rs","mod.rs"]}],"files":["app.rs","lib.rs","util.rs"]};
